...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($assets && $date) {
        ...
        $query = $conn->prepare("INSERT INTO main_assets (asset_name, date) VALUES (?, ?)");
        $query->bind_param("ss", $assets, $date);
        ...
        <section class="content">
          <div class="contact-form-wrapper">
            <form class="form p-5 shadow-lg rounded" action="" method="POST">
              ...
              <?php endif; ?>
              <h2 class="text-center mb-4 text-uppercase" style="letter-spacing: 2px; color: #3498db;">Create Asstes</h2>

              <div class="mb-3">
                <input type="text" name="assets" class="form-control" placeholder="Assets Name" required>
              </div>
