...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO construction_cost (project_name, construction_name, amount, date, payment_type, note) 
          VALUES ('$project_name', '$construction_name', '$amount', '$date', '$payment_type', '$note')";
...
$sql = "SELECT * FROM construction_cost 
            ...
            <div class="">
              ...
              <div class="card-body" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                <form action="" method="post" onsubmit="return confirmSubmission()">
                  <div class="mb-3">
                    <label class="form-label" style="font-size: 1rem; font-weight: bold;">Project Name</label>
                    <input type="text" class="form-control form-control" name="project_name" placeholder="Enter project name" required>
                  </div>
                  <div class="mb-3">
                    <label class="form-label" style="font-size: 1rem; font-weight: bold;">Construction Name</label>
            ...
            <table class="table table-striped" style="width: 100%;">
              ...
              <tbody>
                <?php foreach ($constructions as $construction): ?>
                  <tr>
                    <td><?php echo htmlspecialchars($construction['project_name']); ?></td>
                    ...
                    <td><?php echo htmlspecialchars($construction['payment_type']); ?></td>
                    ...
                    <td>
                      ...
                      <a href="javascript:void(0);" onclick="openDeleteModal('delete_add_payment.php?table=construction_cost&id=<?php echo htmlspecialchars($construction['id']); ?>');" class="btn btn-sm btn-danger">Delete</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
