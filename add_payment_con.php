                ...
                <table class="table table-striped" style="width: 100%;">
                   ...
                   <div class="mt-3">
                    <strong>Total Amount: </strong>
                     <span>
                        <?php 
                        // Calculate total amount for the specific main_project_id
                        $total_amount_sql = "SELECT SUM(amount) as total_amount FROM projects WHERE main_project_id = '$main_project_id'";
                        $total_amount_result = mysqli_query($conn, $total_amount_sql);
                        $total_amount_row = mysqli_fetch_assoc($total_amount_result);
                        echo htmlspecialchars(number_format($total_amount_row['total_amount'], 0)); 
                        ?>
                        ৳</span>
                </div>
                ...
                <div class="d-flex justify-content-center align-items-center mt-4">
                    <div class="d-flex gap-3">
                        ...
                        for ($i = $start_page; $i <= $end_page; $i++): ?>
                            <a href="?id=<?php echo $main_project_id; ?>&page=<?php echo $i; ?>" class="btn btn-outline-secondary <?php echo ($i == $page) ? 'active' : ''; ?>">
                                <?php echo $i; ?>
                            </a>
                        <?php endfor; ?>
