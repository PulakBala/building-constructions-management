                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($row["nid_number"]); ?></td>
                            <td>
                                <a href="<?php echo htmlspecialchars($row["nid_img"]); ?>" target="_blank">View Image</a>
                            </td>
                            <td><?php echo htmlspecialchars($row["created_at"]); ?></td>
                            <td>
                                <!-- Action buttons -->
                                <a href="edit-flat.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="delete_flat_info.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
                            </td>
                        </tr>
                    <?php
                    }
