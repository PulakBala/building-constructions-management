...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($projects && $date) {
        ...
        $query = $conn->prepare("INSERT INTO main_expense (expense_name, date) VALUES (?, ?)");
        ...
        <section class="content">
          <div class="contact-form-wrapper">
            <form class="form p-5 shadow-lg rounded" action="" method="POST">
              ...
              <?php endif; ?>
              <h2 class="text-center mb-4 text-uppercase" style="letter-spacing: 2px; color: #3498db;">Create Expense</h2>

              <div class="mb-3">
                <input type="text" name="projects" class="form-control" placeholder="Expense Name" required>
              </div>
