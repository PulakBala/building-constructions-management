...
?>
                        ...
                        $fetchQuery = "SELECT flat_bill.f_flatId, owner_name, flatname, flat_bill.f_month, flat_bill.f_year, 
                                                ...
                                                MAX(flat_bill.marked) AS marked
                                            FROM flat_bill 
                        ...
                        echo "
                                ...
                                <div class='ml-2 p-1'>
                                    <form id='billReportForm'  method='GET'>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                           // $all_due_flat_zero = true;  // Initialize the flag to true
                            ...
                            echo "<td><div class='color'>৳" . number_format($final_total, 0) . '</div></td>';  // Change the color as needed
          ...
          <div class="modal-dialog">
            ...
            <script>
                        ...
                        if (row) {
                            ...
                            if (confirm("Change color? Yes or No?")) {
