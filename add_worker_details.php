...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO workers_details (name, address, contact, worker_title, date) VALUES ('$worker_name', '$address', '$contact', '$worker_title', '$date')";
                    ...
                    <tbody>
                        <?php foreach ($revenues as $revenue): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($revenue['address']); ?></td>
                                <td><?php echo htmlspecialchars($revenue['contact']); ?></td>
